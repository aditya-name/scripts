...
if queryValidFlag == 0:
    prozedurenFromV2.guiReturn("nothing to show")
else:
    rp = connection.execute(s_sql)
    results_list = rp.fetchall()
    # prozedurenFromV2.guiReturn(results_list[0][0])  # for baustein single statement
